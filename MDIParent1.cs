...
namespace FinalProject
{
    public partial class MDIParent1 : Form
    {
        ...
        {
            Create_New_User cu = new Create_New_User();
            cu.Show();
        }
        ...
        {
            Dealer_Information di = new Dealer_Information();
            di.Show();
        }

        private void buyingProductToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Buying_Info bi = new Buying_Info();
            bi.Show();
        }
